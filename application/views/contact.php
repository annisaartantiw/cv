		...
		<div class="container">
			<div class="row animate-box">
				<div style="margin-top: 2cm" class="col-md-12 col-md-offset-0 text-center fh5co-heading">
					...
					<li ><a href="https://wa.me/6281217201130?
						text=Hallo%20*Artanti*,%20Saya%20tertarik%20dengan%20CV%20kamu." target=
						"_blank" class="btn btn-common">Chat Me On WhatsApp</a></li>
				</div>
			</div>
			<!-- <div class="row">
